CKEDITOR.plugins.add( 'figurebox', {
    ...
    init: function( editor ) {
		...
		editor.widgets.add( 'figurebox', {
			...
			allowedContent: 'figure(!inside_story, image_portrait); figcaption(!inside_story_caption); div(figure_content, caption_text, source_text, clearfix);img[src,alt,title,data-imagemodel]{height, width}()',
