CKEDITOR.plugins.add( 'figurebox', {
    ...
    init: function( editor ) {
		...
		editor.widgets.add( 'figurebox', {
			...
			allowedContent: 'figure(!inside_story, image_portrait); figcaption(!inside_story_caption); div(figure_content, caption_text, source_text, clearfix);img[src,alt,title,data-imagemodel,data-expandable-url,data-expandable-type]{height, width}',
			...
			editables: {
				content: {
					...
					// is focused.
					allowedContent: 'img[src, title, alt, data-imagemodel,data-expandable-url,data-expandable-type]{height, width}; div(embed-container); iframe[allowfullscreen, frameborder, !src]'
				},
				caption: {
