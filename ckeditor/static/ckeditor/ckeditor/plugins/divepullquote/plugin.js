...
CKEDITOR.plugins.add( 'divepullquote', {
    ...
    init: function( editor ) {
		...
		editor.widgets.add( 'divepullquote', {
			...
			allowedContent: 'div(!pullquote, pq-hr-wrapper, pq-headshot, pq-speaker-details); p(pq-quote, pq-speaker, pq-speaker-title); img[src,alt,title]{height, width}(pq-headshot-img, pq-headshot-img-hidden); hr;',


			// Minimum HTML which is required by this widget to work.
			requiredContent: 'div(pullquote); p(pq-quote, pq-speaker, pq-speaker-title);',
