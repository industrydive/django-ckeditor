...
(function() {
	...
	CKEDITOR.plugins.add( 'diveimage', {
		...
		init: function( editor ) {
			...
			var allowed = 'img[alt,!src,data-imagemodel,data-expandable-url,data-expandable-type]{border-style,border-width,float,height,margin,margin-bottom,margin-left,margin-right,margin-top,width}',
			...
			editor.on( 'doubleclick', function( evt ) {
				...
				if(element.hasClass("pq-headshot-img") || element.hasClass("pq-headshot-img-hidden")){
